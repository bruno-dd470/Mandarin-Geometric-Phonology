...
% pandoc v4_final_en.md --template=template_phono.tex -o v4_final_en.pdf --pdf-engine=xelatex --bibliography=references.bib --csl=ieee.csl --citeproc --toc --toc-depth=2
